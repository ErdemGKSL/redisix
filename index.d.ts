export class RedisX<T extends string> {
  constructor(namespace: string, redisClient: import("redis").RedisClientType, indexes?: T[]);
  set(value: object | string, customIndexes: { [I in T]: string }, options?: import("redis").SetOptions): Promise<any>;
  get(query: { [I in T]: string }, defaultValue: any): Promise<object | string | null>;
  indexList: T[];
  client: RedisClient;
}
