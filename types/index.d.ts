export class RedisX {
    constructor(namespace: string, redisClient: import("redis").RedisClientType, indexes?: any[]);
    set(value: object, customIndexes: any, options?: import("redis").SetOptions): Promise<any>;
    get(query: {}, defaultValue: any): Promise<any>;
    get indexList(): any[];
    get client(): import("redis").RedisClientType<{
        graph: {
